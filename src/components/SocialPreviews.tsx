    ...
    <div className="rounded-xl border border-neutral-200 bg-white overflow-hidden">
      ...
      <div className="border-b border-neutral-200 bg-white p-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <span className={`text-xs font-mono font-semibold px-2 py-1 rounded ${isOverLimit ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-700'}`}>
              {charCount}/{limit}
            </span>
      ...
      <div className="border-b border-neutral-200 bg-white p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-bold text-neutral-900">Facebook Stories</p>
              <p className="text-xs text-neutral-500">Format court pour stories</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <span className={`text-xs font-mono font-semibold px-2 py-1 rounded ${isOverLimit ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-700'}`}>
      ...
      <div className="border-b border-neutral-200 bg-white p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-bold text-neutral-900">Instagram Stories</p>
              <p className="text-xs text-neutral-500">Format court pour stories</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            ...
            <CopyButton content={caption} label="Copier" />
          </div>
        </div>
      </div>
