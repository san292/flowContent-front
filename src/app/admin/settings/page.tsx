...
function loadFromLocalStorage<T>(key: string, defaultValue: T): T {
  // Vérifier qu'on est côté client (pas SSR)
...
const SettingsPage = () => {
   const [blogSettings, setBlogSettings] = useState(() =>
    loadFromLocalStorage("blogSettings", {
 ...
 const [socialSettings, setSocialSettings] = useState(() =>
    loadFromLocalStorage("socialSettings", {
  ...
  const testConnection = async (platform: string) => {
    ...
    alert(
      `Test de connexion ${platform} - Fonctionnalité à implémenter avec votre backend`
    );
  };
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            setBlogSettings({
                              ...blogSettings,
                              publicationFrequency: e.target.value,
                            })
                          }
                          className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500"
                        >
                        ...
                        <div className="flex items-center justify-between mb-4">
                          <div className="flex items-center">
                            <input
                              ...
                              checked={
                                socialSettings[
                                  `${key}Enabled` as keyof SocialSettings
                                ] as boolean
                              }
                              onChange={(e) =>
                                setSocialSettings({
                          ...
                          <div className="space-y-4">
                            <div>
                              ...
                              <input
                                ...
                                value={
                                  socialSettings[
                                    `${key}ApiKey` as keyof SocialSettings
                                  ] as string
                                }
                                onChange={(e) =>
                                  setSocialSettings({
                            ...
                            <div className="rounded-md bg-gray-50 p-3">
                              <p className="text-xs text-gray-600">
                                Pour obtenir votre clé API {label}, rendez-vous
                                sur le portail développeur de {label}
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="rounded-md bg-blue-50 p-4">
                      ...
                      <p className="text-sm text-blue-700">
                        Cette section sera connectée à votre backend Node.js qui
                        gère la génération d&apos;articles. Vos paramètres d&apos;IA
                        seront transmis à votre système de génération
                        automatique.
                      </p>
                    </div>
                    ...
                    <div className="border-t border-gray-200 pt-6">
                      ...
                      <p className="mt-2 text-xs text-gray-500">
                        Ce prompt sera utilisé par défaut pour la génération
                        d&apos;articles
                      </p>
                    </div>
