...
async function getAdminStats(): Promise<AdminStats> {
  ...
  const [total, published, drafts, todayCount] = await Promise.all([
    ...
    supabase.from("articles").select("id", { count: "exact" }).gte("created_at", today)
  ]);
            ...
            <div className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-semibold text-gray-900">{stats.publishedArticles}</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-semibold text-gray-900">{stats.draftArticles}</p>
                </div>
              </div>
            </div>
          </div>
