...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    async function loadData() {
      try {
        // ✅ Récupérer tous les articles via l'API backend
        ...
        setStats(statsData);
        setRecentArticles(sortedArticles as RecentArticle[]);
      } catch (error) {
          ...
          <div className="lg:col-span-1">
            <div className="rounded-lg bg-white shadow">
              ...
              <div className="p-6 space-y-4">
                ...
                <Link
                  href="/admin/social"
                  className="flex w-full items-center justify-center rounded-lg bg-purple-600 px-4 py-3 text-sm font-medium text-white transition-colors hover:bg-purple-700"
                >
                  <svg
                    className="mr-2 h-4 w-4"
                    fill="none"
